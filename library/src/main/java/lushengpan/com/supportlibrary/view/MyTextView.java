...
//        textSize = attrs.getAttributeIntValue(namespace, "textSize", UIUtils.dip2px(14));//字体大小
...
//        paddingRight = attrs.getAttributeIntValue(namespace, "paddingRight", UIUtils.dip2px(20));
