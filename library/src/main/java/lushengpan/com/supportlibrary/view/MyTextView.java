...
/**
 * Created by ${lushengpan} on 2016/7/6.
 */
public class MyTextView extends TextView {
    ...
    public MyTextView(Context context, AttributeSet attrs) {
        ...
        textSize = attrs.getAttributeIntValue(namespace, "textSize", UIUtils.dip2px(14,context));//字体大小
        textColor = attrs.getAttributeIntValue(namespace, "textColor", Color.parseColor("#464854"));//字体颜色
        paddingLeft = attrs.getAttributeIntValue(namespace, "paddingLeft", 0);
        paddingRight = attrs.getAttributeIntValue(namespace, "paddingRight", UIUtils.dip2px(20,context));
    ...
    public MyTextView(Context context, float textSize, int textColor,
