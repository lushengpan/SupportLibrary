...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private void init() {
        ...
        mClearDrawable.setBounds(0, 0, getHeight() / 2, getHeight() / 2);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        if (hasFocus) {
            ...
            if (onLostFocusListener != null) {
                onLostFocusListener.onLostFocusListener(v);
            }
        }
    }
    ...
    public interface OnLostFocusListener {
        public void onLostFocusListener(View v);
    }

    public OnLostFocusListener onLostFocusListener;
