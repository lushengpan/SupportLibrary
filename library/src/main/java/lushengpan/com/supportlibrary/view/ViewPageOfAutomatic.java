...
//
//public class ViewPageOfAutomatic {
//    /**
//     * 上一个高亮指示点的角标
//     */
...
//     * ViewPager的构造函数
//     */
//    public ViewPageOfAutomatic(Context context, ViewPager view, DisplayImageOptions displayImageOptions) {
//        // super();
//        this.view = view;
...
//                if (style != 1) {
//                    point.setImageResource(R.drawable.shouye_dian_de2x);
//                } else {
//                    point.setImageResource(R.drawable.shangjiaxiangqing_btn_lunbo_bai2x);
//                }
//                // 利用布局参数对象来设置指示点的间距
//                LayoutParams params = new LayoutParams(UIUtils.dip2px(5, context), UIUtils.dip2px(5, context));
//                params.gravity = Gravity.CENTER_VERTICAL;
//                if (i == 0) {
//                    // 第一个指示点默认高亮
//                    point.setEnabled(true);
//                    point.setImageResource(R.drawable.shouye_dian_se2x);
//                } else {
//                    // 除了第一个,都离前一个有5px的距离
...
//                        // 指示点变大
//                        ((ImageView) ll_point.getChildAt(myIndex)).setImageResource(R.drawable.shouye_dian_se2x);
//                        // 将上一个指示点取消高亮
...
//                        if (style != 1) {
//
//                            ((ImageView) ll_point.getChildAt(mLastPoint)).setImageResource(R.drawable.shouye_dian_de2x);
//                        } else {
//                            ((ImageView) ll_point.getChildAt(mLastPoint)).setImageResource(R.drawable.shangjiaxiangqing_btn_lunbo_bai2x);
//
//                        }
//                    }
//                }
