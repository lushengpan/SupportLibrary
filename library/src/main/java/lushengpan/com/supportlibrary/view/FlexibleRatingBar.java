...
//
//    private int colorOutlineOn = Color.rgb(0xFE, 0xB7, 0x4D);
//    private int colorOutlineOff = Color.rgb(0xFE, 0xB7, 0x4D);
//    private int colorOutlinePressed = Color.rgb(0xFF, 0xB7, 0x4D);
//    private int colorFillOn = Color.rgb(0xFF, 0xB7, 0x4D);
...
//        try {
//            colorOutlineOn = a.getInteger(R.styleable.FlexibleRatingBar_colorOutlineOn, Color.rgb(0xFF, 0xB7, 0x4D));
//            colorOutlineOff = a.getInteger(R.styleable.FlexibleRatingBar_colorOutlineOff, Color.rgb(0xFF, 0xB7, 0x4D));
//            colorOutlinePressed = a.getInteger(R.styleable.FlexibleRatingBar_colorOutlinePressed, Color.rgb(0xFF, 0xB7, 0x4D));
//            colorFillOn = a.getInteger(R.styleable.FlexibleRatingBar_colorFillOn, Color.rgb(0xFF, 0xB7, 0x4D));
...
//            strokeWidth = (int) a.getDimension(R.styleable.FlexibleRatingBar_myStrokeWidth, -1);
//        } finally {
//            a.recycle();
//        }
//    }
