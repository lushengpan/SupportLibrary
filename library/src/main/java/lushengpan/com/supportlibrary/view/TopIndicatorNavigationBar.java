...
public class TopIndicatorNavigationBar extends LinearLayout implements
	...
	public TopIndicatorNavigationBar(Context context) {
		super(context);
	...
	public void attachToParent(ViewGroup viewGroup, String[] titles,
		...
		ll_navigation.setBackgroundColor(Color.WHITE);
		ll_navigation.setOrientation(HORIZONTAL);
		ll_navigation.setGravity(Gravity.CENTER);
		...
		ivBottomLine.setImageResource(android.R.color.holo_blue_light);
